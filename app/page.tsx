...
/* Wizard steps (display order only) */
type WizardStep =
  | "team"
  | "adoption"
  | "priorities"
...
export default function Page() {
  ...
  /* Step 3: priorities */
  const priorityOrder: PriorityKey[] = ["throughput", "retention", "upskilling"]; // screens
        ...
        <div className="panel">
          ...
          {stepKey === "team" && (
            <div>
              ...
              {/* Average salary only (costs revealed later) */}
              ...
              <div className="mt-6 flex justify-end gap-3">
                <button className="btn-ghost" onClick={() => setStepKey("team")}>← Back</button>
          ...
          {stepKey === "adoption" && (
            <div>
              ...
              <p className="muted text-sm mb-3">Slide to estimate current AI-in-workflow adoption. Higher adoption = more weekly hours reclaimed.</p>
          ...
          {stepKey === "priorities" && (
            <div>
              ...
              <div className="mt-6 flex justify-end gap-3">
                <button className="btn-ghost" onClick={() => setStepKey("adoption")}>← Back</button>
          ...
          {stepKey === "throughput" && selected.includes("throughput") && (
            <div>
              ...
              <div className="mt-6 flex justify-end gap-3">
                <button className="btn-ghost" onClick={() => setStepKey("priorities")}>← Back</button>
                <button className="btn" onClick={() => setStepKey(nextChosenConfig("throughput") ?? "results")}>Continue →</button>
              </div>
            </div>
          )}
          ...
          {stepKey === "retention" && selected.includes("retention") && (
            <div>
              ...
              <div className="mt-6 flex justify-end gap-3">
                <button className="btn-ghost" onClick={() => setStepKey("throughput")}>← Back</button>
                <button className="btn" onClick={() => setStepKey(nextChosenConfig("retention") ?? "results")}>Continue →</button>
              </div>
            </div>
          )}
          ...
          {stepKey === "upskilling" && selected.includes("upskilling") && (
            <div>
              ...
              <div className="mt-6 flex justify-end gap-3">
                <button className="btn-ghost" onClick={() => setStepKey("retention")}>← Back</button>
          ...
          {stepKey === "results" && (
            <div>
              ...
              <div className="mt-6 flex justify-between">
                <button className="btn-ghost" onClick={() => setStepKey(priorityOrder.find((k) => selected.includes(k)) as WizardStep ?? "priorities")}>← Back</button>
